...
$colors = <|"background" -> RGBColor["#140516"], "fontcolor" -> RGBColor[
    "#eeeeee"], "primary" -> RGBColor["#eaa0eb"], "variable" -> RGBColor[
    "#55f7df"], "module" -> RGBColor["#e638e9"], "block" -> RGBColor["#35baa7"
    ], "error" -> RGBColor["#f51292"], "headhighlight" -> RGBColor["#02584c"
    ]|>;
...
schemes["Nord"] = <|"background" -> RGBColor["#2e3440"], "fontcolor" 
    -> RGBColor["#d8dee9"], "primary" -> RGBColor["#88c0d0"], "variable" 
    -> RGBColor["#8fbcbb"], "module" -> RGBColor["#81a1c1"], "block" -> RGBColor[
    "#5e81ac"], "error" -> RGBColor["#bf616a"], "headhighlight" -> RGBColor[
    "#b48ead"]|>;

schemes["Solarized"] = <|"background" -> RGBColor["#002b36"], "fontcolor"
     -> RGBColor["#eee8d5"], "primary" -> RGBColor["#b58900"], "variable"
     -> RGBColor["#6c71c4"], "module" -> RGBColor["#268bd2"], "block" -> 
    RGBColor["#cb4b16"], "error" -> RGBColor["#dc322f"], "headhighlight" 
    -> RGBColor["#2aa198"]|>;

schemes["Gruvbox"] = <|"background" -> RGBColor["#282828"], "fontcolor"
     -> RGBColor["#ebdbb2"], "primary" -> RGBColor["#689d6a"], "variable"
     -> RGBColor["#b16286"], "module" -> RGBColor["#458588"], "block" -> 
    RGBColor["#98971a"], "error" -> RGBColor["#cc241d"], "headhighlight" 
    -> RGBColor["#d65d0e"]|>;

schemes["Dracula"] = <|"background" -> RGBColor["#282a36"], "fontcolor"
     -> RGBColor["#f8f8f2"], "primary" -> RGBColor["#ff79c6"], "variable"
     -> RGBColor["#8be9fd"], "module" -> RGBColor["#ffb86c"], "block" -> 
    RGBColor["#f1fa8c"], "error" -> RGBColor["#ff5555"], "headhighlight" 
    -> RGBColor["#bd93f9"]|>;

schemes["OneDark"] = <|"background" -> RGBColor["#282c34"], "fontcolor"
     -> RGBColor["#abb2bf"], "primary" -> RGBColor["#98c379"], "variable"
     -> RGBColor["#e5c07b"], "module" -> RGBColor["#61afef"], "block" -> 
    RGBColor["#c678dd"], "error" -> RGBColor["#e06c75"], "headhighlight" 
    -> Black|>;

schemes["Jakob"] = <|"background" -> RGBColor["#18181c"], "fontcolor"
     -> RGBColor["#cad0df"], "primary" -> RGBColor["#af82bb"], "variable"
     -> RGBColor["#f6a04b"], "module" -> RGBColor["#fbc46a"], "block" -> 
    RGBColor["#637dae"], "error" -> RGBColor["#bb212d"], "headhighlight" 
    -> RGBColor["#3b4c78"]|>;
...
SetColors[colors_Association] /; AllTrue[colors, MatchQ[_RGBColor | _GrayLevel
    ]] :=
    Module[{},
        $colors = Merge[{$colors, colors}, Last];
    ];

SetColors[colors_List] /; AllTrue[colors, MatchQ[_RGBColor | _GrayLevel
    ]] :=
    Module[{assoc},
...
SetColors[key_String, color_RGBColor | color_GrayLevel] :=
    Module[{assoc},
        assoc = <|key -> color|>;
        SetColors[assoc];
    ];
...
GetColors[slot_Integer:All, OptionsPattern[]] :=
    Module[{hex, nohex},
...
GetColors[key_String, OptionsPattern[]] :=
    Module[{hex, nohex},
        hex = Boole @ OptionValue["Hex"];
        nohex = Boole @ !OptionValue["Hex"];
...
NewAssoc[colors_List] :=
    Module[{diff, keys, cutKeys, cutColors},
...
ColorToHex[color_RGBColor] :=
    Module[{red, green, blue},
        red = StringPadLeft[#, 2, "0"]& @ IntegerString[#, 16]& @ Round
             @ (255 color[[1]]);
        green = StringPadLeft[#, 2, "0"]& @ IntegerString[#, 16]& @ Round
             @ (255 color[[2]]);
        blue = StringPadLeft[#, 2, "0"]& @ IntegerString[#, 16]& @ Round
             @ (255 color[[3]]);
        "#" <> red <> green <> blue
    ]

ColorToHex[color_GrayLevel] :=
    Module[{gray},
        gray = StringPadLeft[#, 2, "0"]& @ IntegerString[#, 16]& @ Round
             @ (255 color[[1]]);
        "#" <> gray <> gray <> gray
    ]
...
DeleteStyleSheet[] :=
    DeleteFile[FileNameJoin[{$UserBaseDirectory, "SystemFiles", "FrontEnd",
         "StyleSheets", "maTHEMEatica.nb"}]];

DeleteCSS[] :=
    DeleteFile[FileNameJoin[{$UserBaseDirectory, "FrontEnd", "frontend.css"
        }]];
...
Options[CreateStyleSheet] = {"LightMode" -> False, "BlackInputBoxes" 
    -> False};
...
CreateStyleSheet[OptionsPattern[]] :=
    Module[{light, dark, fallback},
        ...
        $stylesheet =
            Notebook[
                {
                    (*Setting Default inheritance to Defa.nb*){light,
                         dark} = Boole @ {#, !#}& @ OptionValue["LightMode"];
                    ...
                    CellGroupData[
                        {
                            Cell["General setup and variable colors",
                                 "Subsection"]
                            ,
                            Cell[StyleData["Notebook"], CellBracketOptions
                                 -> {"HoverColor" -> GetColors["primary"]}, AutoStyleOptions -> {"LocalVariableStyle"
                                 -> {FontColor -> GetColors["module"]}, "FunctionLocalVariableStyle" 
                                -> {FontColor -> GetColors["block"]}, "PatternVariableStyle" -> {FontColor
                                 -> GetColors["variable"], FontSlant -> "Italic"}, "UndefinedSymbolStyle"
                                 -> {FontColor -> GetColors["primary"]}}, CodeAssistOptions -> {"HeadHighlightStyle"
                                 -> {Background -> GetColors["headhighlight"], GetColors["fontcolor"]
                                }, "MatchHighlightStyle" -> {Background -> GetColors["primary"], FontColor
                                 -> GrayLevel[0]}, "MenuDefaultFillColor" -> GetColors["primary"], "MenuDarkFillColor"
                                 -> Black, "MenuBorderColor" -> Black}, FontColor -> GetColors["fontcolor"
                                ], Background -> GetColors["background"]]
                            ,
                            Cell[
                                StyleData["Input"]
                                ,
                                If[OptionValue["BlackInputBoxes"],
                                    Background -> Black
                                    ,
                                    ##&[]
                                ]
                            ...
                            Cell[
                                ...
                                ,
                                If[OptionValue["BlackInputBoxes"],
                                    Background -> Lighter[GetColors["background"
                                        ], 0.1]
                                    ,
                                    ##&[]
                                ]
                    ...
                    ,
                    CellGroupData[{Cell["Headers", "Subsection"], Cell[
                        StyleData["Section"], FontColor -> GetColors["primary"]], Cell[StyleData[
                        "Subsection"], FontColor -> GetColors["variable"]], Cell[StyleData["Subsubsection"
                        ], FontColor -> GetColors["module"]], Cell[StyleData["Item"], CellDingbat
...
PlayAround[] :=
    Module[{},
        Manipulate[CreateStyleSheet[{Hue[x], RGBColor["#35baa7"], RGBColor[
            "#e638e9"], RGBColor["#55f7df"], RGBColor["#bf59de"], RGBColor["#bc0bf3"
            ]}], {z, 0, 1}] ApplyStyleSheet;
    ]

ApplyStyleSheet[] :=
    SetOptions[EvaluationNotebook[], StyleDefinitions -> $stylesheet];

SaveStyleSheet[] :=
    Module[{},
        Export[FileNameJoin[{$UserBaseDirectory, "SystemFiles", "FrontEnd",
             "StyleSheets", "maTHEMEatica.nb"}], $stylesheet];
    ];

SetDefault[] :=
    Module[{file},
        file = FileNameJoin[{$UserBaseDirectory, "SystemFiles", "FrontEnd",
             "StyleSheets", "maTHEMEatica.nb"}];
...
CreateCSS[arg_:"primary", OptionsPattern[]] :=
    Module[{},
        $cssString = "
* {
    background: " <> GetColors["background",
             "Hex" -> True] <> ";
    color: " <> GetColors["fontcolor", "Hex" ->
             True] <> ";
